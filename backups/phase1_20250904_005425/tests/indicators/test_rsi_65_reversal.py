    ...
    try:
        async with async_session() as db_session:
            ...
            if all_profits_1h:
                ...
                print(
                    f"RSI 65反転 - 1時間後: 平均{avg_profit_1h:.2f}pips, 勝率{win_rate_1h:.1f}%"
                )
            ...
            if all_profits_4h:
                ...
                print(
                    f"RSI 65反転 - 4時間後: 平均{avg_profit_4h:.2f}pips, 勝率{win_rate_4h:.1f}%"
                )
            ...
            if all_profits_1d:
                ...
                print(
                    f"RSI 65反転 - 1日後: 平均{avg_profit_1d:.2f}pips, 勝率{win_rate_1d:.1f}%"
                )
