...
class BasicPatternsTester:
    ...
    async def _test_single_pattern(self, pattern_num: int, test_data: pd.DataFrame) -> Dict:
        """単一パターンのテスト"""
    ...
    def _generate_summary(self):
        ...
        detected_patterns = sum(1 for result in self.test_results.values() 
...
async def main():
    ...
    parser.add_argument('--patterns', default='1,2,3,4,5,6', 
                       help='テストするパターン番号（カンマ区切り）')
