    ...
    try:
        async with async_session() as db_session:
            ...
            for pattern in test_patterns:
                print(f"\n🔍 {pattern['name']} テスト...")
                print(f"条件: 買いRSI < {pattern['buy_rsi']}, 売りRSI > {pattern['sell_rsi']}")
                ...
                if total_signals > 0:
                    ...
                    if buy_count > 0:
                        ...
                        if buy_profits:
                            ...
                            print(f"  買い: 平均利益 {avg_buy_profit:.1f}pips, 勝率 {buy_win_rate:.1f}%")
                    ...
                    if sell_count > 0:
                        ...
                        if sell_profits:
                            ...
                            print(f"  売り: 平均利益 {avg_sell_profit:.1f}pips, 勝率 {sell_win_rate:.1f}%")
