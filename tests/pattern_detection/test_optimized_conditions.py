...
async def test_optimized_conditions():
    ...
    try:
        async with async_session() as db_session:
            ...
            print("\n📊 シグナル詳細:")
            print("=" * 120)
            print(f"{'時刻':<20} {'タイプ':<6} {'RSI':<6} {'価格':<8} {'1時間後':<10} {'4時間後':<10} {'1日後':<10} {'1時間利益':<12} {'4時間利益':<12} {'1日利益':<12}")
            print("=" * 120)
            ...
            for rsi, sma, ema_12, ema_26, atr, signal_price, signal_time, timeframe in signals:
                if rsi and sma and ema_12 and ema_26 and atr and signal_price:
                    # シグナルタイプを判定
                    buy_condition = rsi < 55 and signal_price > sma and ema_12 > ema_26 and 0.01 <= atr <= 0.10
                    sell_condition = rsi > 45 and signal_price < sma and ema_12 < ema_26 and 0.01 <= atr <= 0.10
                    ...
                    print(f"{time_str:<20} {signal_type:<6} {rsi_str:<6} {price_str:<8} {price_1h:<10} {price_4h:<10} {price_1d:<10} {profit_1h:<12} {profit_4h:<12} {profit_1d:<12}")
