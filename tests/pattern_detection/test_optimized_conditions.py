...
最適化された条件（RSI < 55 / > 45）で4時間後の結果も含めて詳細検証
"""
        ...
        async with async_session() as db_session:
            ...
            result = await db_session.execute(
                text(
                    ...
                    AND (
                        (ti1.value < 55 AND pd.close_price > ti2.value AND ti3.value > ti4.value AND 0.01 <= ti5.value AND ti5.value <= 0.10) OR
                        (ti1.value > 45 AND pd.close_price < ti2.value AND ti3.value < ti4.value AND 0.01 <= ti5.value AND ti5.value <= 0.10)
                    )
            ...
            print("=" * 120)
            print(
                f"{'時刻':<20} {'タイプ':<6} {'RSI':<6} {'価格':<8} {'1時間後':<10} {'4時間後':<10} {'1日後':<10} {'1時間利益':<12} {'4時間利益':<12} {'1日利益':<12}"
            )
            print("=" * 120)
            ...
            for (
                ...
                if rsi and sma and ema_12 and ema_26 and atr and signal_price:
                    ...
                    print(
                        f"{time_str:<20} {signal_type:<6} {rsi_str:<6} {price_str:<8} {price_1h:<10} {price_4h:<10} {price_1d:<10} {profit_1h:<12} {profit_4h:<12} {profit_1d:<12}"
                    )
            ...
            print("\n🎯 結論:")
            print("✅ 最適化された条件（RSI < 55 / > 45）で詳細検証完了")
            print("✅ 4時間後の結果も含めて包括的な分析を実施")
            print("✅ 買い/売り別のパフォーマンスも確認可能")
