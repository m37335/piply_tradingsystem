            ...
            for rsi_level, description in test_conditions:
                ...
                if signal_count > 0:
                    ...
                    if profits_1h:
                        ...
                        win_rate = len([p for p in profits_1h if p > 0]) / len(profits_1h) * 100
                        signal_rate = (signal_count / total_count) * 100 if total_count > 0 else 0
                        
                        print(f"{description:<25} {signal_count:<12} {signal_rate:<12.2f}% {win_rate:<12.1f}% {avg_profit:<15.2f}pips")
                    else:
                        signal_rate = (signal_count / total_count) * 100 if total_count > 0 else 0
                        print(f"{description:<25} {signal_count:<12} {signal_rate:<12.2f}% {'N/A':<12} {'N/A':<15}")
                else:
                    print(f"{description:<25} {signal_count:<12} {'0.00':<12}% {'N/A':<12} {'N/A':<15}")
