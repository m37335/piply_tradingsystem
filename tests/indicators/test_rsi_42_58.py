...
async def test_rsi_42_58():
    """RSI 42/58でテスト"""
    print("=" * 80)
    print("🔍 RSI 42/58テスト - より現実的な条件で検証")
    print("=" * 80)
        ...
        async with async_session() as db_session:
            ...
            result = await db_session.execute(
                text(
                    ...
                    AND (
                        (ti1.value < 42 AND pd.close_price > ti2.value AND ti3.value > ti4.value AND ti2.value > ti5.value AND 0.01 <= ti6.value AND ti6.value <= 0.10) OR
                        (ti1.value > 58 AND pd.close_price < ti2.value AND ti3.value < ti4.value AND ti2.value < ti5.value AND 0.01 <= ti6.value AND ti6.value <= 0.10)
                    )
            ...
            if len(signals) == 0:
                print("❌ シグナルなし - 条件がまだ厳しすぎる可能性があります")
                return
            ...
            print("- RSI 42/58: より少ないシグナル、高い厳格さ")
            print("- RSI 40/60: 0件のシグナル、非常に厳格")

            print("\n🎯 結論:")
            print("✅ RSI 42/58条件で実際のデータベース検証完了")
